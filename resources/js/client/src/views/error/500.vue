...
<template>
  <main class="min-h-screen place-items-center px-6 py-24 sm:py-32 lg:px-8">
    <div class="text-center">
      ...
      >
        Sorry, we couldn’t find the page you’re looking for. Already working to solve the problem.
      </p>
